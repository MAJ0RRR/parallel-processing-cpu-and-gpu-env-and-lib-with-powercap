...
def time_powercap_scatter(experiment_result: ExperimentResult):
    ...
    plt.ylabel("time [s]")
    plt.legend()
    plt.savefig(f'{experiment_result.experiment_result[0].parameters.app_name}_time_power_cap_nodes_{experiment_result.experiment_result[0].parameters.number_of_nodes}.png')
    plt.close()
...
def time_batch_size_scatter(experiment_result: ExperimentResult):
    ...
    plt.ylabel("time [s]")
    plt.legend()
    plt.savefig(f'{experiment_result.experiment_result[0].parameters.app_name}_time_batch_size_nodes_{experiment_result.experiment_result[0].parameters.number_of_nodes}.png')
    plt.close()


def time_number_of_nodes_bar(experiment_result: ExperimentResult):
    number_of_nodes = [multiple_run_result.parameters.number_of_nodes for multiple_run_result in experiment_result.experiment_result]
...
def time_number_of_nodes_scatter(experiment_result: ExperimentResult):
    nodes_cpu_gpu_one_stream = [multiple_run_result.parameters.number_of_nodes for multiple_run_result in experiment_result.experiment_result if multiple_run_result.parameters.cpu_enabled and multiple_run_result.parameters.number_of_streams == 1]
    ...
    nodes_cpu_gpu_two_streams = [multiple_run_result.parameters.number_of_nodes for multiple_run_result in experiment_result.experiment_result if multiple_run_result.parameters.cpu_enabled and multiple_run_result.parameters.number_of_streams == 2]
    ...
    nodes_gpu_one_stream = [multiple_run_result.parameters.number_of_nodes for multiple_run_result in experiment_result.experiment_result if not multiple_run_result.parameters.cpu_enabled and multiple_run_result.parameters.number_of_streams == 1]
    ...
    nodes_gpu_two_streams = [multiple_run_result.parameters.number_of_nodes for multiple_run_result in experiment_result.experiment_result if not multiple_run_result.parameters.cpu_enabled and multiple_run_result.parameters.number_of_streams == 2]
    ...
    plt.ylabel("time [s]")
    plt.legend()
    plt.savefig(f'{experiment_result.experiment_result[0].parameters.app_name}_time_nodes_nodes_{experiment_result.experiment_result[0].parameters.number_of_nodes}.png')
    plt.close()
